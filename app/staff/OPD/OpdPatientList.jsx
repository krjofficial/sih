	...
	return (
		<SafeAreaView style={styles.container}>
			<ScrollView  style={styles.scrollView}>
				...
				<TouchableOpacity style={styles.buttonRow} onPress={()=>props.navigation.navigate("AddOpdPatient")}>
					<Image
...
const styles = StyleSheet.create({
  ...
  input3: {
	...
	text16: {
		...
		fontSize: 8,
		flex: 1,
		marginRight: 100, // Corrected property name
	},
		...
		text18: {
			...
			fontSize: 8,
			flex: 1,
			marginLeft: 6, // Adjust as needed for left spacing
			marginRight: 0, // Adjust as needed for right spacing
		},
